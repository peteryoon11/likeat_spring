...
//	            	curPage++;
	                ...
	                $.ajax({
	                    ...
	                    url : 'region/infiniteScrollListSongpa.jsp',// 요청할 서버의 url
						data : {	
							curPage:curPage
	                    },
...
<body id="mainPage">
	...
	<div class="container" style="padding-top: 50px">
		...
		<div class="row">
			<div class="col-lg-4">
				<h1 class="page-header" style="color: orange; font-style: italic; font-weight: bold;">송파구 TOPeat!</h1>
			</div>
		</div>
		<!-- /.row -->
		<!-- Projects Row -->
	...
	<div class="container newContainer" style="padding-top: 50px">
		...
		<div class="row">
			<div class="col-lg-4">
				<h1 class="page-header" style="color: orange; font-style: italic; font-weight: bold;">송파구 NEWeat!</h1>
			</div>
		</div>
		<!-- /.row -->
		<!-- Projects Row -->
		...
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header" style="color: orange; font-style: italic; font-weight: bold;">
					송파구 LIKEat! <small>all the list</small>
				</h1>
			</div>
		</div>
		<!-- /.row -->
